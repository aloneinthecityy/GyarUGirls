...
$id_usuario_comentador = $_SESSION['id_usuario'];
$id_usuario = $_GET['id_usuario'];

if (isset($_POST['submitComentario'])) {
  $comentario = $_POST['comentario'];

  $sqlInsereComentario = "INSERT INTO tb_comentario_mural (id_usuario_comentador, id_usuario, comentario) VALUES ($id_usuario_comentador, $id_usuario, '$comentario')";
  $result = pg_query($conn, $sqlInsereComentario);

  if ($result) {
    // a consulta SQL foi executada com sucesso
    header("Location: ./meuMural.php?id_usuario=$id_usuario");
    exit();
  } else {
...
$sql = "SELECT A.*, B.* 
        ...
        tb_comentario_mural as B 
        where A.id_usuario = B.id_usuario_comentador 
  ...
  <div class="wrapper justify-center	justify-items-center">
    ...
    <section class="py-16 px-32">
      <div class="content rounded-2xl	bg-pink-200 py-12 px-20">
        <h3 class="font-itim font-bold text-xl">Comentários do seu perfil:</h3>
