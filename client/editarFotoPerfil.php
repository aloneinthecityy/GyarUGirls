...
function uploadImagem($imagem)
{
  ...
  if ($verificaEnvioDoArquivo == false) {
    ...
    $message = 'Imagem enviada com sucesso, clique aqui para visualizar a imagem <a href= "./images/perfil_usuario/' . $novoNome . '.' . $extensao . '">Clique aqui</a>';
    return $patch;
  }
}
